...
# Trouver un moyen de soit rendre joueurs_concernes unique
# Soit slice la table_joueurs_nv par lensemble des joueurs_concernes

#table_joueurs_ayant_joue = table_joueurs_nv[table_joueurs_nv["id"]]
...
#    cur.execute("INSERT INTO mmr_variations (player_id, mmr, sigma) VALUES (%s, %s, %s);", [int(table_joueurs_nv.loc[i,"id"]), int(table_joueurs_nv.loc[i,"mmr"]), int(table_joueurs_nv.loc[i,"sigma"])])

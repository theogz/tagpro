...
conn = psycopg2.connect(dbname="tagpro", user="postgres", host="localhost")

cur = conn.cursor(cursor_factory=psycopg2.extras.DictCursor)

# Create the table of players and the first players
cur.execute("CREATE TABLE players (id serial PRIMARY KEY, name varchar, mmr integer default 0, sigma integer default 0);")
